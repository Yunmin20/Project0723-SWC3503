						...
						<div class = "col-lg-6">
							<form method = "POST" action = "save_book_query.php" enctype = "multipart/form-data">
								<div class = "form-group">
									<label>Book Entry Number:</label>
									<input type = "text" name = "entry_number" required = "required" class = "form-control" />
								</div>
								<div class = "form-group">
								...
								<div class = "form-group">
									...
									<input type = "text" name = "book_author" required = "required" class = "form-control" required = "required" />
								<div class = "form-group">
									<label>Publisher:</label>
									<input type = "text" name = "book_publisher" required = "required" class = "form-control" />
								</div>
								<div class = "form-group">
									<label>Book ISBN:</label>
									<input type = "text" name = "book_isbn" class = "form-control" required = "required"/>
								</div>
								...
								<div class = "form-group">
									...
									<input type = "text" name = "book_shelf" required = "required" class = "form-control" />
								</div>
								<div class = "form-group">
