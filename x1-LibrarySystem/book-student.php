<!DOCTYPE html>
<?php
	require_once 'valid-student.php';
?>	
<html lang = "eng">
	<head>
	...
	<body style = "background-color:#f69d9d;">
		...
		<div class = "container-fluid">
			<div class = "col-lg-2 well" style = "margin-top:60px;">
				<div class = "container-fluid">
					<br />
					<br />
					<label class = "text-muted"><?php  echo "Hello user. <br>This page is for you to search books availability in our system. <br>Thank you.";?></label>
				</div>
			...
			<div class = "col-lg-9 well" style = "margin-top:60px;">
				<div class = "alert alert-info">Book / Search Availability</div>
